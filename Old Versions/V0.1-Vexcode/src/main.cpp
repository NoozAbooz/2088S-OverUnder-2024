...
void usercontrol(void) {
  ...
  while(true){
    ...
    int leftPower = (Controller1.Axis1.position(percent) + Controller1.Axis3.position(percent)) / powerModifier;
    int rightPower = (Controller1.Axis1.position(percent) - Controller1.Axis3.position(percent)) / powerModifier;
    ...
    if(driveMode == 1){
      ...
      if(Controller1.ButtonR1.pressing()){
        ...
        Controller1.Screen.print(powerModifier);
